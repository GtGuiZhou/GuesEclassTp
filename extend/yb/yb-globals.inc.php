<?php
	...
	if(!defined('YBAPI_CLASSESS_DIR')) {
		...
		require(YBAPI_CLASSESS_DIR . 'YBException.php');
		require(YBAPI_CLASSESS_DIR . 'YBOpenApi.php');
		require(YBAPI_CLASSESS_DIR . 'YBAPI' . DIRECTORY_SEPARATOR . 'YBAPI_IApp.php'); //轻应用模块
	}
?>